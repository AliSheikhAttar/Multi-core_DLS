...
class ExampleDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExampleDSLParser#bool.
    def enterBool(self, ctx:ExampleDSLParser.BoolContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#bool.
    def exitBool(self, ctx:ExampleDSLParser.BoolContext):
        pass
