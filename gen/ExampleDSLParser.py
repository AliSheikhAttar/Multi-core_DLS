# Generated from /home/asa/Code/Git/Compiler_Design/minesweeper/grammar/ExampleDSL.g4 by ANTLR 4.13.1
# encoding: utf-8
from antlr4 import *
...
class ExampleDSLParser ( Parser ):
    ...
    ruleNames =  [ "start", "program", "output", "output_types", "hint", 
                   "bool", "initiate_game", "width", "height", "bomb_placements", 
    ...
    class HintContext(ParserRuleContext):
        ...
        def bool_(self):
            return self.getTypedRuleContext(ExampleDSLParser.BoolContext,0)
    ...
    class BoolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ExampleDSLParser.RULE_bool
    ...
    def bool_(self):
        ...
        localctx = ExampleDSLParser.BoolContext(self, self._ctx, self.state)
